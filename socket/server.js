...
let agOptions = {
  authPrivateKey: JSON.parse(process.env.PRIVATE_KEY_JSON),
  authPublicKey: JSON.parse(process.env.PUBLIC_KEY_JSON),
};
...
client.on("message", function (channel, message) {
  ...
  agServer.exchange.transmitPublish(event, data);
});
